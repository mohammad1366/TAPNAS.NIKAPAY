...
@Component({
  ...
  template: `
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label for="inputCard16DigitNumber">شماره دستگاه</label>
          <input type="text" class="form-control" id="inputCard16DigitNumber" placeholder="شماره دستگاه" [(ngModel)]="inputCard16DigitNumber">
        </div>
      </div>
  ...
  <div class="col-sm-6">
    <div class="form-group">
      <label for="inputCustomerId">عنوان دستگاه</label>
      <input type="text" class="form-control" id="inputCustomerId" placeholder="عنوان دستگاه" [(ngModel)]="inputCustomerId">
    </div>
  </div>
...
export class ModalComponent {
  ...
  types = [{id:null,name:'انتخاب کنید'},{id:1,name:'پوز فروشگاهی'}, {id:2,name:'پوز سیار'}, {id:3,name:'پوز تاکسی'}, {id:4,name:'پوز اتوبوسی'}];
